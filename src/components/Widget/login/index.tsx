import { useEffect, Component, useState, ReactNode } from "react";
...
export default function Login() {
  ...
  const init = () => {
    ...
    material.map = new THREE.TextureLoader().load(
      require("../../../assets/login/earth_bg.png")
    );
    ...
    const initSceneStar = (initZposition: number) => {
      ...
      const sprite1 = new THREE.TextureLoader().load(
        require("../../../assets/login/starflake1.png")
      );
      const sprite2 = new THREE.TextureLoader().load(
        require("../../../assets/login/starflake2.png")
      );
      parameters = [
    ...
    const initTubeRoute = (
      ...
      const cloudTexture = textureLoader.load(
        require("../../../assets/login/cloud.png")
      );
    ...
    const renderCloudMove_second = initCloudMove(
  ...
  return (
    <div className="container">
      ...
      <div className="content">
        <img
          className="login-plane-human"
          src={require("../../../assets/login/login_human.png")}
          alt=""
        />
